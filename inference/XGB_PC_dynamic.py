...
def image_pc_inference_dynamic(
        model_folder,
        data_folder,
        output_folder,
):
    ...
    feat_dir = model_folder / 'XGB_PC' / 'results_true_hyper'

    save_dir = output_folder / 'ImagePC' / 'Dynamic'
    model_dir = model_folder / 'XGB_PC' / 'models_true'
